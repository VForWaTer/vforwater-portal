...
class DateRangeSlider(forms.DateInput):
    ...
    def render(self, name, value, attrs=None, renderer=None):
        ...
        html = loader.get_template('vfw_home/daterangeslider_widget.html')\
...
class DateTimeRangeSlider(forms.DateTimeInput):
    ...
    def render(self, name, value, attrs=None, renderer=None):
        ...
        self.elem_id = re.findall(r'id_([A-Za-z0-9_\./\\-]*)"', s)[0]
        html = loader.get_template('vfw_home/datetimerangeslider_widget.html')\
            .render(context={'onchange': self.onchange,
                             'elem_id': self.elem_id,
                             'elem_name': self.elem_name,
                             'minimum': self.minimum,
