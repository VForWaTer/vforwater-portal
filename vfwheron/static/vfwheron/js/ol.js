...
;(function (root, factory) {
    ...
    function ha(a) {
        this.message = "Assertion failed. See https://openlayers.org/en/v4.6.1/doc/errors/#" + a + " for details.";
        this.code = a;
...
*/
    ...
    k.set = function (a, b, c) {
        c ? this.O[a] = b : (c = this.O[a], this.O[a] = b, c !== b && Yc(this, a, c))
    };
    k.H = function (a, b) {
    ...
    k.ci = function (a) {
        ...
        0 === this.O && (this.i.forEach(Gc), this.i.length = 0, this.l = !1, this.c = null, Pc(this.a), this.a = null)
    };
    k.pm = function (a) {
        de(this, a);
    ...
    function Hh(a) {
        ...
        this.N = a.constrainResolution || !1;
        this.a = null;
    ...
    function Bi(a, b, c, d, e) {
        ...
        this.O = d;
        this.ob = e;
        this.M = this.b = this.a = this.Wa = this.N = this.T = null;
    ...
    function Fi(a, b) {
        ...
        d ? (d.lineCap != b.lineCap && (d.lineCap = c.lineCap = b.lineCap), od && (jc(d.lineDash, b.lineDash) || c.setLineDash(d.lineDash = b.lineDash), d.lineDashOffset != b.lineDashOffset && (d.lineDashOffset = c.lineDashOffset = b.lineDashOffset)), d.lineJoin != b.lineJoin && (d.lineJoin = c.lineJoin = b.lineJoin), d.lineWidth != b.lineWidth && (d.lineWidth = c.lineWidth = b.lineWidth), d.miterLimit != b.miterLimit && (d.miterLimit = c.miterLimit = b.miterLimit), d.strokeStyle != b.strokeStyle && (d.strokeStyle = c.strokeStyle = b.strokeStyle)) :
            (c.lineCap = b.lineCap, od && (c.setLineDash(b.lineDash), c.lineDashOffset = b.lineDashOffset), c.lineJoin = b.lineJoin, c.lineWidth = b.lineWidth, c.miterLimit = b.miterLimit, c.strokeStyle = b.strokeStyle, a.N = {
                lineCap: b.lineCap,
                lineDash: b.lineDash,
    ...
    bj.prototype.$c = function (a, b) {
        ...
        l[0] || l[1] || bb(m) || (e = e.projection, this.c ? (e = this.c.context, l = kb({}, a, {
            size: [cb(m) / g, db(m) / g],
            viewState: kb({}, a.viewState, {rotation: 0})
        }), this.c.$c(l, b) && (e.canvas.width = l.size[0] * c, e.canvas.height = l.size[1] * c, this.c.df(l, b, e)), this.M = new ai(m, g, c, e.canvas)) : (e = h.Y(m, g, c, e)) && Si(this, e) && (this.M = e));
        this.M && (e = this.M, m = e.G(),
            b = e.resolution, e = e.a, l = c * b / (g * e), m = ef(this.f, c * d[0] / 2, c * d[1] / 2, l, l, 0, e * (m[0] - f[0]) / b, e * (f[1] - m[3]) / b), ef(this.l, c * d[0] / 2 - m[4], c * d[1] / 2 - m[5], c / g, -c / g, 0, -f[0], -f[1]), Ui(a, h), this.i = b * c / e);
        return !!this.M
    };
    ...
    mj.prototype.$c = function (a, b) {
        ...
        e = e.center;
        var h = this.a, l = h.ha(), m = l.g, n = l.eb(f), p = n.Dc(g, this.N), q = n.Ta(p), r = Math.round(g / q) || 1,
            u = a.extent;
    ...
    k.Xa = function (a) {
        if (this.N) {
            var b = af(this.ca, this.N.slice());
            a.translate(b[0], b[1]);
            a.rotate(this.$)
        }
        a.fill();
        this.N && a.setTransform.apply(a, ri)
    };
    ...
    function Lj(a, b, c, d, e, f) {
        ...
        this.O = this.o = this.v = this.s = this.l = this.C = this.D = this.j = this.f = this.c = this.g = void 0
    }
    ...
    Lj.prototype.yc = function (a, b) {
        if (this.M) {
            ...
            this.a.push([6, d, a, this.M, this.g, this.c, this.B, this.f, this.j, this.D, this.C, this.l, this.s, this.v * this.pixelRatio, this.o, this.O]);
            this.b.push([6, d, a, this.V, this.g, this.c, this.B, this.f, this.j, this.D, this.C, this.l, this.s, this.v, this.o, this.O]);
            Fj(this, b)
        }
    };
    ...
    Lj.prototype.bf = function () {
        ...
        this.M = this.V = null;
        this.O = this.o = this.s = this.l = this.C = this.D = this.j = this.v = this.f = void 0
    };
    ...
    function Tj(a, b, c, d) {
        ...
        a.a.push([6, c, d, b, (h - a.D) * g, (l - a.l) * g, a.O, b.height, 1, 0, 0, a.C, a.B, 1, !0, b.width, e.padding == hi ? hi : e.padding.map(function (a) {
            return a * g
        }), !!e.backgroundFill, !!e.backgroundStroke]);
        a.b.push([6, c, d, b, (h - a.D) * g, (l - a.l) * g, a.O, b.height, 1, 0, 0, a.C, a.B, 1 / g, !0, b.width, e.padding, !!e.backgroundFill, !!e.backgroundStroke])
    }
    ...
    k.df = function (a, b, c) {
        ...
        if (r && !r.yg()) {
            ...
            if (n.D && h.g) {
                ...
                n = cb(m);
                var Ia = 0;
                for (h -= n; h < m[0];) --Ia, p = n * Ia, p = $i(this, a, p), r.Na(A, p, l, f), h += n;
                Ia = 0;
                h = d[2];
                for (h += n; h > m[2];) ++Ia, p = n * Ia, p = $i(this, a, p), r.Na(A, p, l, f), h -= n;
                p = $i(this, a, 0)
            }
            qi(A, l, S / 2, e / 2);
    ...
    k.$c = function (a) {
        ...
        g = a.viewState;
        e = g.projection;
        var h = g.resolution, l = a.pixelRatio;
        a = b.g;
        var m = b.f;
        d = b.get(ik);
        void 0 === d && (d = ck);
        f = Fa(f, m * h);
        m = g.projection.G();
        c.D && g.projection.g && (g = Math.max(cb(f) / 2, cb(m)), f[0] = m[0] - g, f[2] = m[2] + g);
        if (!this.i && this.v == h && this.o == a && this.l == d && La(this.j, f)) return !0;
        this.c = null;
        this.i = !1;
        var n = new Uj(.5 * h / l, f, h, l, c.$, this.f, b.f);
        c.ae(f, h, e);
        e = function (a) {
            var c = a.ib();
            if (c) var d = c.call(a, h); else (c = b.ib()) && (d = c(a, h));
            if (d) {
                if (d) {
                    c = !1;
                    if (Array.isArray(d)) for (var e = 0, f = d.length; e < f; ++e) c = ek(n, a, d[e], dk(h, l), this.Wi, this) || c; else c = ek(n, a, d, dk(h, l), this.Wi, this);
                    a = c
                } else a = !1;
                this.i = this.i || a
            }
    ...
    function jk(a) {
        this.context = null;
        mj.call(this, a);
        this.O = a.D ? rj.Jc(9) : null;
        this.D = !1;
        this.ca = We();
        this.N = "vector" == a.l ? 1 : 0;
        ...
        if (v.Be || v.wf != r || v.eh != u) {
            ...
            for (var Ia = 0, ta = m.a.length; Ia < ta; ++Ia) {
                ...
                if (3 != la.getState()) {
                    ...
                    v.Be = !1;
                    ia = new Uj(0, ia, S, p, z.s, this.O, n.f);
    ...
    k.di = function (a) {
        ...
        if (-1 == d) this.g.length = this.c.length = 0, this.b && (this.b.length = 0), this.a && (this.a.length = 0); else {
            ...
            f = f[1];
            g = this.ab;
            l = [Math.max(a[0], this.N), Math.max(a[1], this.T), Math.min(a[2], this.qa), Math.min(a[3], this.oa)];
    ...
    function ml(a, b) {
        ...
        this.N = a.getUniformLocation(b, "o");
    ...
    function Nl(a, b) {
        ...
        this.Wa = null;
        this.width = this.scale = this.rotation = this.rotateWithView = this.N = this.T = this.opacity = void 0
    }
    ...
    function Ol(a, b, c, d) {
        var e = a.D, f = a.C, g = a.height, h = a.oa, l = a.qa, m = a.opacity, n = a.T, p = a.N,
    ...
    k.gb = function () {
        ...
        this.b = null;
        this.scale = this.rotation = this.rotateWithView = this.N = this.T = this.opacity = void 0;
        this.a = null;
        this.width = void 0
    };
    ...
    function Ul(a, b) {
        ...
        this.c = a.getUniformLocation(b, "j");
        this.oa = a.getUniformLocation(b, "k");
        this.N = a.getUniformLocation(b, "l");
        this.a = a.getUniformLocation(b, "m");
        this.C = a.getUniformLocation(b, "n");
    ...
    k.Wb = function (a, b) {
        if (this.ta) {
            ...
            var f = Ym(this, b), g, h, l = Math.round(f[0] * this.ab - this.$),
                m = Math.round(f[1] * this.ra - this.ca), n = this.O.lineWidth / 2 * this.O.scale;
            f = 0;
    ...
    mn.prototype.Zi = function (a, b, c) {
        ...
        d.uniformMatrix4fv(f.c, !1, pl(this.C, this.O));
    ...
    function tn(a, b, c, d) {
        ...
        if (a.a.a.hasOwnProperty(f)) a = a.a.get(f), e.bindTexture(3553, a.Mb), 9729 != a.hi && (e.texParameteri(3553, 10240, 9729), a.hi = 9729), 9729 != a.ji && (e.texParameteri(3553, 10241, 9729), a.ji = 9729); else {
            ...
            if (0 < d) {
                ...
                a.D !== c[0] || a.O !== c[1] ? (h.width = c[0], h.height = c[1], a.D = c[0], a.O = c[1]) : l.clearRect(0, 0, c[0], c[1]);
    ...
    k.Bg = function (a, b, c) {
        var d = this.c, e = c.b, f = a.viewState, g = f.projection, h = this.a, l = h.ha(), m = l.eb(g),
            n = m.Dc(f.resolution), p = m.Ta(n), q = l.Zd(n, a.pixelRatio, g), r = q[0] / Ba(m.Za(n), this.N)[0],
    ...
    k.Bg = function (a, b, c) {
        ...
        l && (l = ck);
        g = Fa(g, p * m);
        if (!this.s && this.T == m && this.N == h && this.B == l && La(this.D, g)) return !0;
    ...
    k.load = function () {
        0 == this.state && (oj(this, 1), this.C(this, this.O), this.D(null, NaN, null))
    };
    k.Cp = function (a, b, c) {
        this.vg(b);
        this.Ij(a);
    ...
    k.Xl = function (a) {
        var b = this.a.aa();
        a = ko(this, pa(1 === this.j ? (a.offsetX - this.N[0] / 2) / this.D : (a.offsetY - this.N[1] / 2) / this.v, 0, 1));
    ...
    function U(a) {
        ...
        this.V = a.url;
        void 0 !== a.loader ? this.o = a.loader : void 0 !== this.V && (oa(this.N, 7), this.o = Fo(this.V, this.N));
    ...
    function Ew(a) {
        ...
        if (!b) if ("Circle" === this.N) b = function (a, b) {
    ...
    k.Pd = function () {
        ...
        "MultiPoint" === this.N ? a.Va(new No([b])) : "MultiLineString" === this.N ? a.Va(new P([b])) : "MultiPolygon" === this.N && a.Va(new Q([b]));
    ...
    function cx(a, b) {
        var c = a.T;
        c ? c.U().na(b) : (c = new Hk(new C(b)), a.T = c, a.N.ha().Gb(c))
    }
    ...
    k.Dj = function () {
        if (this.N && "pointerdrag" != this.N.type) {
            var a = this.N;
            nx(this, a);
            var b = this.j, c = {}, d, e;
    ...
    function Bx(a) {
        ...
        this.N = void 0 !== a.vertex ? a.vertex : !0;
    ...
    function Fx(a, b, c, d) {
        ...
        if (0 < g.length) {
            ...
            } else a.C && (f = h ? Ae(c, g[0].feature.U()) : Be(c, m), l = d.Ia(f), Ie(b, l) <= a.f && (e = !0, a.N &&
    ...
    function V(a) {
        ...
        this.j(function (a) {
            ...
            c || (c = [new Bk({image: new dr({opacity: a, src: this.N})})], this.T[b] = c);
            return c
        }.bind(this));
        this.set(ik, null);
    ...
    function W(a) {
        ...
        this.N(a.useInterimTilesOnError ? a.useInterimTilesOnError : !0);
    ...
    hy.prototype.he = function () {
        ...
        if (0 === a.length) this.state = 3; else {
            ...
            this.O = dy(d, c, this.C, e, this.c.G(), b, f, this.o, a, this.D, this.B);
            this.state = 2
        }
        this.u()
    };
    ...
    k.Wc = function (a, b, c, d) {
        ...
        c = this.$ ? c : 1;
        var e = this.M;
        if (e && this.N == this.g && e.resolution == b && e.a == c && La(e.G(), a)) return e;
    ...
    k.aj = function (a) {
        this.N = void 0 !== a ? a : Fk;
        this.s = a ? Dk(this.N) : void 0;
        this.u()
    };
    ...
    function Ny(a) {
        ...
        this.B = [0, 0];
        this.V = 0;
        this.N = void 0 !== a.ratio ? a.ratio : 1.5
    }
    ...
    k.Wc = function (a, b, c, d) {
        ...
        a = fb(f, e, 0, [Math.ceil(this.N * cb(a) / e), Math.ceil(this.N * db(a) / e)]);
    ...
    function pz(a, b, c, d, e, f, g, h, l, m, n, p, q, r, u) {
        ...
        if (f) {
            ...
            h.Vf(v, h.Dc(z), function (a) {
                ...
                c && (b = gb(b, c));
                .5 <= cb(b) / z && .5 <= db(b) / z && (b = a.toString(), c = m[b], c || (c = g(a, n, p), c = m[b] = new q(a, void 0 == c ? 4 : 0, void 0 == c ? "" : c, d, e), this.O.push(y(c, "change", r))), c.c++, this.a.push(b))
            }.bind(this))
        }
    }
    ...
    W.prototype.setUseInterimTilesOnError = W.prototype.N;
    ...
    ao.prototype.setUnits = ao.prototype.N;
