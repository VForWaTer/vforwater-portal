...
from vfwheron.views import HomeView, LogoutView,LoginView
...
class HomeViewTest(TestCase):
    def test_uses_home_template(self):
        ...
        self.assertTemplateUsed(response, 'vfwheron/home/')
    ...
    #def test_home_view_returns_correct_html(self):
       ...
       # html = response.content.decode('utf8')
        ...
        #self.assertTemplateUsed(response, 'vfwheron/home.html')
...
class LogoutViewTest(TestCase):
    ...
    def test_can_save_a_POST_request(self):
        ...
        self.assertRedirects(response, expected_url='vfwheron/home/', status_code=302, target_status_code=200)
...
class LoginViewTest(TestCase):
    ...
    def test_login_as_admin_layer(self):
        ...
        self.assertRedirects(response, expected_url='vfwheron/home/rsp/login/init...', status_code=302, target_status_code=200)
