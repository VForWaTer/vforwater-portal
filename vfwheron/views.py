...
from vfwheron.query_functions import get_bbox_from_data, get_filter_values, second_filter_level, get_first_level
...
class HomeView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        get_unit_id = TblVariable.objects.select_related('variable_id').values_list('variable__name')
        all_variable_names = get_unit_id.values('variable_name', 'variable_symbol', 'unit__unit_symbol')
        return {'dataExt': get_bbox_from_data(), 'first_level':get_first_level(), 'all_names': all_variable_names}
